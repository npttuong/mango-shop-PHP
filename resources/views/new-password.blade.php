  ...
  <main>
    ...
    <form action="{{ route('reset.password.post') }}" method="post">
      ...
      <div class="form-outline mb-4 reset_password_form"><br>
        ...
        <input type="password" id="form3Example3ce"
          class="form-control form-control-lg form-textinput reset_password_emailinput" name="password" value=""
          onchange="check_pass()" />
      </div>
      <div class="form-outline mb-4 reset_password_form"><br>
        <b><label class="form-label" for="form3Example3cg">Xác nhận mật khẩu mới</label></b><br>
        <input type="password" id="form3Example3cf"
          class="form-control form-control-lg form-textinput reset_password_emailinput" name="confirm_password"
          value="" onchange="check_pass()" />
      </div>

      <div class="d-flex justify-content-center">
        <button type="submit" class="btn btn-success btn-block gradient-custom-4 text-body btn-login" name="dangnhap"
