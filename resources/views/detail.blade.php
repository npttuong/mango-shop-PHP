...
@section('js')
  <!-- Custom select input -->
  <script defer src="/js/increse-input-custom.js"></script>
@endsection
...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-lg-7 bg--white detail__info mt-lg-0 mt-sm-3">
      ...
      <span class="detail__info-price">{{ $product->unit_price - $product->unit_price * $product->discount }}Đ</span>
      @if ($product->discount > 0)
        <span class="detail__info-unit-price">{{ $product->unit_price }}Đ</span>
      @endif
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-wrap">
          @foreach ($product->sizes as $item)
            <label class="container-radio">
              <input type="radio" name="sizes" value="{{ $item->size }}" checked>
              {{ $item->size }}
      ...
      <div class="d-flex mt-4">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-wrap">
          @foreach ($product->colors as $item)
            <label class="container-radio">
              <input type="radio" name="colors" value="{{ $item->color_code }}" checked>
              {{ $item->color }}
              <span class="checkmark-radio"></span>
            </label>
          @endforeach
      ...
      <div class="mt-4 d-flex">
        <div class="incremment-wrapper me-5">
          ...
          <input type="number" name="cart-quantity" value="1" min="1" step="1" hidden>
        </div>
