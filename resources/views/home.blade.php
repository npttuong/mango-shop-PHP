      ...
      <div class="carousel-inner">
        <div class="carousel-item carousel-img active" style="background-image: url('/img/carousel-1.jpg');">
          ...
          <div class="position-center">
            ...
            <a href="/shop" class="carousel-item__inner-btn carousel-item__inner-btn--white animate__animated animate__fadeInUp">
        ...
        <div class="carousel-item carousel-img" style="background-image: url('/img/carousel-3.jpg');">
          <div class="white-overlay"></div>
          <div class="position-center">
            <h2 class=" carousel-item__inner-heading animate__animated
                                    animate__fadeInDown">
